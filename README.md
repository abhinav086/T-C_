...
This privacy policy applies to the La fitnesse select app (hereby referred to as "Application") for mobile devices that was created by La fitnesse Select (hereby referred to as "Service Provider") as a Free service. This service is intended for use "AS IS".
